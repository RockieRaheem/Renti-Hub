...
import { building, kpis, revenueMonthly, revenueMix, transactions, alerts, upcomingPayments } from '../data/currentBuilding'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        <div className="lg:col-span-3 bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-400">Rental income &mdash; {building.name}</p>
            </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <h3 className="text-base font-semibold text-gray-900 mb-5">Alerts</h3>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-50">
                  {['Unit', 'Tenant', 'Status', 'Amount'].map((h) => (
