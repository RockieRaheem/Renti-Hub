            ...
            {floor.units.map((unit) => {
              ...
              return (
                <Link
                  ...
                  className="block bg-surface rounded-lg border border-outline p-4 hover:border-primary/30 hover:shadow-card-hover transition-all group"
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <span className="material-symbols-outlined text-on-surface-dim group-hover:text-primary transition-colors">chevron_right</span>
                    </div>
                  </div>
                </Link>
              )
